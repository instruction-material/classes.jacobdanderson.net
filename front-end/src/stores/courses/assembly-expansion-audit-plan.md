# Assembly Expansion Audit Plan

## Current State Snapshot

- Course file: `front-end/src/stores/courses/assembly.ts`
- Mapped repository: `Assembly`
- Mapped repository link: https://github.com/instruction-material/Assembly
- Instruction-Material local inventory: 6 visible top-level directories, 2 top-level files
- Module count: 14
- Curriculum entry count: 45
- `projectLink` count: 1
...
1. Catalog parity check indicates 14 module headers and 45 curriculum entries; confirm each has deliberate sequencing and completion criteria.
...
- Reconcile catalog modules against `Assembly` and confirm linkable starter/solution sources.
