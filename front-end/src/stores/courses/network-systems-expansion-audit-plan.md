# Network Systems Expansion Audit Plan

## Current State Snapshot

- Course file: `front-end/src/stores/courses/network-systems.ts`
- Mapped repository: `Network-Systems`
- Mapped repository link: https://github.com/instruction-material/Network-Systems
- Instruction-Material local inventory: 6 visible top-level directories, 1 top-level files
- Module count: 14
- Curriculum entry count: 49
- `projectLink` count: 1
- `solutionLink` count: 1
- Repo folder overlap: 0/6 (0%) of top-level repo folders appear in catalog links.
- Top-level repo folders detected from links: 0 across 0 repo(s)
- Representative linked folders: No overlap detected yet.

## Audit Findings

1. Catalog parity check indicates 14 module headers and 49 curriculum entries; confirm each has deliberate sequencing and completion criteria.
...
- Reconcile catalog modules against `Network-Systems` and confirm linkable starter/solution sources.
