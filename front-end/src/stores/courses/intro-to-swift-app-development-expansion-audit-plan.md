# Intro to Swift App Development Expansion Audit Plan

## Current State Snapshot

- Course file: `front-end/src/stores/courses/intro-to-swift-app-development.ts`
- Mapped repository: `Swift`
- Mapped repository link: https://github.com/instruction-material/Swift
- Instruction-Material local inventory: 22 visible top-level directories, 2 top-level files
- Module count: 23
- Curriculum entry count: 90
- `projectLink` count: 9
- `solutionLink` count: 9
- Repo folder overlap: 1/22 (5%) of top-level repo folders appear in catalog links.
- Top-level repo folders detected from links: 1 across 1 repo(s)
- Representative linked folders: SADX-SwiftUI-Shapes-Studio

## Audit Findings

1. Catalog parity check indicates 23 module headers and 90 curriculum entries; confirm each has deliberate sequencing and completion criteria.
2. Starter/solution balance is uneven: `projectLink` count is 9 while `solutionLink` count is 9.
...
- Reconcile catalog modules against `Swift` and confirm linkable starter/solution sources.
