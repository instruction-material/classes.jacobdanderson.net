# AI Level 1 Expansion Audit Plan

## Current State Snapshot

- Course file: `front-end/src/stores/courses/ai-level-1.ts`
- Mapped repository: `AI-Level-1`
- Mapped repository link: https://github.com/instruction-material/AI-Level-1
- Instruction-Material local inventory: 37 visible top-level directories, 35 top-level files
- Module count: 10
- Curriculum entry count: 40
- `projectLink` count: 3
- `solutionLink` count: 1
- Repo folder overlap: 0/37 (0%) of top-level repo folders appear in catalog links.
- Top-level repo folders detected from links: 1 across 1 repo(s)
- Representative linked folders: No overlap detected yet.

## Audit Findings

1. Catalog parity check indicates 10 module headers and 40 curriculum entries; confirm each has deliberate sequencing and completion criteria.
...
- Reconcile catalog modules against `AI-Level-1` and confirm linkable starter/solution sources.
