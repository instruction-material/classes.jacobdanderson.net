# Rust Systems Security Expansion Audit Plan

## Current State Snapshot

- Course file: `front-end/src/stores/courses/rust-systems-security.ts`
- Mapped repository: `Rust-Systems-Security`
...
1. Catalog parity check indicates 11 module headers and 33 curriculum entries; confirm each has deliberate sequencing and completion criteria.
...
- Reconcile catalog modules against `Rust-Systems-Security` and confirm linkable starter/solution sources.
...
- Add threat-modeling checkpoints before and after every practical lab.
- Add at least one case-study module covering defense-in-depth and secure defaults.
- Add post-assessment activities around disclosure, ethics, and evidence capture.
