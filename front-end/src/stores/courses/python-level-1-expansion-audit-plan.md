# Python Level 1 Expansion Audit Plan

## Current State Snapshot

- Course file: `front-end/src/stores/courses/python-level-1.ts`
- Mapped repository: `Python-Level-1`
- Mapped repository link: https://github.com/instruction-material/Python-Level-1
- Instruction-Material local inventory: 224 visible top-level directories, 112 top-level files
- Module count: 18
- Curriculum entry count: 118
- `projectLink` count: 20
- `solutionLink` count: 91
- Repo folder overlap: 108/224 (48%) of top-level repo folders appear in catalog links.
- Top-level repo folders detected from links: 108 across 1 repo(s)
- Representative linked folders: Check-in-1, Check-in-Two-Additional-Practice-ProjectUpdated, Conditionals-and-Booleans-Recap, End-of-Course-Reflection, Etch-A-Sketch, Event-Listener-Discovery, Event-Listener-Recap, Event-Listener-Recap-Template, Functions-2-Recap, Functions-2-Recap-Template, Functions-Recap, Functions-Recap-Template

## Audit Findings

1. Catalog parity check indicates 18 module headers and 118 curriculum entries; confirm each has deliberate sequencing and completion criteria.
2. Starter/solution balance is uneven: `projectLink` count is 20 while `solutionLink` count is 91.
...
- Reconcile catalog modules against `Python-Level-1` and confirm linkable starter/solution sources.
