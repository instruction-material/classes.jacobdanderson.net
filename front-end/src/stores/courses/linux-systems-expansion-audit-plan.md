# Linux Systems Expansion Audit Plan

## Current State Snapshot

- Course file: `front-end/src/stores/courses/linux-systems.ts`
- Mapped repository: `Linux-Systems`
- Mapped repository link: https://github.com/instruction-material/Linux-Systems
- Instruction-Material local inventory: 6 visible top-level directories, 1 top-level files
- Module count: 13
- Curriculum entry count: 51
- `projectLink` count: 1
...
1. Catalog parity check indicates 13 module headers and 51 curriculum entries; confirm each has deliberate sequencing and completion criteria.
...
- Reconcile catalog modules against `Linux-Systems` and confirm linkable starter/solution sources.
