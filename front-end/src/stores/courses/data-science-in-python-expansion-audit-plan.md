# Data Science in Python Expansion Audit Plan

## Current State Snapshot

- Course file: `front-end/src/stores/courses/data-science-in-python.ts`
- Mapped repository: `Data-Science`
- Mapped repository link: https://github.com/instruction-material/Data-Science
- Instruction-Material local inventory: 4 visible top-level directories, 4 top-level files
- Module count: 10
- Curriculum entry count: 41
- `projectLink` count: 3
- `solutionLink` count: 1
- Repo folder overlap: 0/4 (0%) of top-level repo folders appear in catalog links.
- Top-level repo folders detected from links: 1 across 1 repo(s)
- Representative linked folders: No overlap detected yet.

## Audit Findings

1. Catalog parity check indicates 10 module headers and 41 curriculum entries; confirm each has deliberate sequencing and completion criteria.
2. Starter/solution balance is uneven: `projectLink` count is 3 while `solutionLink` count is 1.
...
- Reconcile catalog modules against `Data-Science` and confirm linkable starter/solution sources.
