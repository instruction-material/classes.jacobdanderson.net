			...
			curriculum: [
				{
					...
					content: [
						...
						"**Use this section:** Read the course as a sequence of reusable habits: observe carefully, name the particles or substances involved, choose a model, connect evidence to the model, check units or ratios when numbers appear, and state what the explanation cannot prove. When reviewing a module, look for the output and checkpoint sections; those are the clearest signs of what should be understood before moving on.",
			...
			curriculum: [
				...
				},
				{
					...
					content: [
						...
						"**Use this section:** Use a decision tree instead of guessing from appearance. First check whether the composition is fixed; if it is fixed, decide whether the particles contain one element or bonded elements in a fixed ratio. If the composition can vary, classify the sample as a mixture and then decide whether it is uniform throughout. For uncertain examples, write the missing evidence rather than forcing a category.",
				...
				},
				{
					...
					content: [
						...
						[
							...
							"| O-H | 463 | S-H | 347 | F-H | 565 |",
							"| Cl-H | 432 | Br-H | 366 | I-H | 299 |",
							"| C-C | 346 | N-C | 305 | O-C | 358 |",
							"| S-C | 272 | F-C | 485 | Cl-C | 339 |",
							"| Br-C | 285 | I-C | 213 | N-N | 163 |",
							"| O-N | 201 | F-N | 283 | Cl-N | 192 |",
							"| O-O | 146 | F-O | 190 | Cl-O | 218 |",
							"| Br-O | 201 | I-O | 201 | S-S | 226 |",
							"| F-S | 284 | Cl-S | 255 | Br-S | 217 |",
							"| F-F | 155 | Cl-F | 253 | Br-F | 249 |",
							"| I-F | 278 | Cl-Cl | 242 | Br-Cl | 216 |",
							"| I-Cl | 208 | Br-Br | 193 | I-Br | 175 |",
							"| I-I | 151 |  |  |  |  |"
						].join("\n"),
						[
