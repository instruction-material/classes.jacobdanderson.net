# Python Level 2 Expansion Audit Plan

## Current State Snapshot

- Course file: `front-end/src/stores/courses/python-level-2.ts`
- Mapped repository: `Python-Level-2`
- Mapped repository link: https://github.com/instruction-material/Python-Level-2
- Instruction-Material local inventory: 111 visible top-level directories, 110 top-level files
- Module count: 17
- Curriculum entry count: 106
- `projectLink` count: 24
- `solutionLink` count: 79
- Repo folder overlap: 101/111 (91%) of top-level repo folders appear in catalog links.
- Top-level repo folders detected from links: 101 across 1 repo(s)
- Representative linked folders: PS-Check-in-1, PS1-Index-Picker, PS1-Mad-Libs, PS1-Relay-Race, PS1-Space-Mountain, PS1-Tip-Calculator, PS10-Field-Day, PS10-Field-Day-II, PS10-Todo-List, PS10-US-Capitals-Quiz, PS10-US-Capitals-Quiz-Starter, PS11-Bank-Account

## Audit Findings

1. Catalog parity check indicates 17 module headers and 106 curriculum entries; confirm each has deliberate sequencing and completion criteria.
2. Starter/solution balance is uneven: `projectLink` count is 24 while `solutionLink` count is 79.
...
- Reconcile catalog modules against `Python-Level-2` and confirm linkable starter/solution sources.
