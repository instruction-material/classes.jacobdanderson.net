# Intro to Physics Expansion Audit Plan

## Current State Snapshot

- Course file: `front-end/src/stores/courses/intro-to-physics.ts`
...
1. Catalog parity check indicates 9 module headers and 49 curriculum entries; confirm each has deliberate sequencing and completion criteria.
...
- Add structured lab notebooks and safety pre-checks for each practical module.
- Add one prediction-to-measurement cycle where students compare expected results to sample data.
- Add extension prompts that connect terminology to real-world applications used in later STEM tracks.
